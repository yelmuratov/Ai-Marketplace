  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden">
        <Button 
          className={`navbar-burger flex items-center p-3 ${darkBackground ? 'text-[#' : 'text-black'}`}
          onClick={showDrawer}
        >
      ...
      <div className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200">
        ...
        <Drawer onClose={onClose} open={open}  className="navbar-menu relative z-50 lg:hidden">
          <div className="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25 z-40"></div>
